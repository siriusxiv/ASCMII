...
alter table question add constraint fk_question_type_1 foreign key (type_id) references type_question (id) on delete restrict on update restrict;
create index ix_question_type_1 on question (type_id);
